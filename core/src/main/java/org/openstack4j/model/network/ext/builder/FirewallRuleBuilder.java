...
public interface FirewallRuleBuilder extends Builder<FirewallRuleBuilder, FirewallRule> {
	...
	FirewallRuleBuilder sourceIpAddresses(List<String> sourceIpAddresses);

	FirewallRuleBuilder destinationIpAddress(List<String> destinationIpAddresses);

	FirewallRuleBuilder sourcePorts(List<String> sourcePorts);

	FirewallRuleBuilder destinationPorts(List<String> destinationPorts);
